...
# Form implementation generated from reading ui file 'testson.ui'
#
...
"}")
        ...
        self.equationInputsLabel = QtWidgets.QLabel(self.centralwidget)
        self.equationInputsLabel.setGeometry(QtCore.QRect(10, 10, 121, 16))
        self.equationInputsLabel.setObjectName("equationInputsLabel")
        self.numberWeightsLabel = QtWidgets.QLabel(self.centralwidget)
        self.numberWeightsLabel.setGeometry(QtCore.QRect(10, 40, 121, 16))
        self.numberWeightsLabel.setObjectName("numberWeightsLabel")
        self.solutionPopulationLabel = QtWidgets.QLabel(self.centralwidget)
        self.solutionPopulationLabel.setGeometry(QtCore.QRect(10, 70, 121, 16))
        self.solutionPopulationLabel.setObjectName("solutionPopulationLabel")
        self.lowLabel = QtWidgets.QLabel(self.centralwidget)
        self.lowLabel.setGeometry(QtCore.QRect(10, 100, 121, 16))
        self.lowLabel.setObjectName("lowLabel")
        self.generateButton = QtWidgets.QPushButton(self.centralwidget)
        self.generateButton.setGeometry(QtCore.QRect(340, 100, 321, 21))
        self.generateButton.setStyleSheet("QPushButton{\n"
"background-color: rgb(56, 255, 166);\n"
"color: rgb(0, 0, 0);\n"
"}\n"
"QPushButton:hover{\n"
...
"}")
        ...
        self.equationInputsEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.equationInputsEdit.setGeometry(QtCore.QRect(140, 10, 191, 20))
        self.equationInputsEdit.setObjectName("equationInputsEdit")
        self.numberWeightsEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.numberWeightsEdit.setGeometry(QtCore.QRect(140, 40, 191, 20))
        self.numberWeightsEdit.setObjectName("numberWeightsEdit")
        self.solutionPopulationEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.solutionPopulationEdit.setGeometry(QtCore.QRect(140, 70, 191, 20))
        self.solutionPopulationEdit.setObjectName("solutionPopulationEdit")
        self.lowEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lowEdit.setGeometry(QtCore.QRect(140, 100, 191, 20))
        self.lowEdit.setObjectName("lowEdit")
        self.highLabel = QtWidgets.QLabel(self.centralwidget)
        self.highLabel.setGeometry(QtCore.QRect(340, 10, 121, 16))
        self.highLabel.setObjectName("highLabel")
        self.numOfGenerationsLabel = QtWidgets.QLabel(self.centralwidget)
        self.numOfGenerationsLabel.setGeometry(QtCore.QRect(340, 40, 121, 16))
        self.numOfGenerationsLabel.setObjectName("numOfGenerationsLabel")
        self.numParentsMatingLabel = QtWidgets.QLabel(self.centralwidget)
        self.numParentsMatingLabel.setGeometry(QtCore.QRect(340, 70, 121, 16))
        self.numParentsMatingLabel.setObjectName("numParentsMatingLabel")
        self.highEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.highEdit.setGeometry(QtCore.QRect(470, 10, 191, 20))
        self.highEdit.setObjectName("highEdit")
        self.numOfGenerationsEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.numOfGenerationsEdit.setGeometry(QtCore.QRect(470, 40, 191, 20))
        self.numOfGenerationsEdit.setObjectName("numOfGenerationsEdit")
        self.numParentsMatingEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.numParentsMatingEdit.setGeometry(QtCore.QRect(470, 70, 191, 20))
        self.numParentsMatingEdit.setObjectName("numParentsMatingEdit")
        self.resetAllDataButton = QtWidgets.QPushButton(self.centralwidget)
        self.resetAllDataButton.setGeometry(QtCore.QRect(10, 130, 321, 21))
        self.resetAllDataButton.setObjectName("resetAllDataButton")
        self.clearInputsButton = QtWidgets.QPushButton(self.centralwidget)
        self.clearInputsButton.setGeometry(QtCore.QRect(340, 130, 321, 21))
        self.clearInputsButton.setObjectName("clearInputsButton")
        self.exitButton = QtWidgets.QPushButton(self.centralwidget)
        self.exitButton.setGeometry(QtCore.QRect(10, 160, 651, 21))
        self.exitButton.setObjectName("exitButton")
        self.solutionTable = QtWidgets.QTableWidget(self.centralwidget)
        self.solutionTable.setGeometry(QtCore.QRect(10, 190, 651, 311))
        self.solutionTable.setStyleSheet("")
        self.solutionTable.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.solutionTable.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.solutionTable.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.solutionTable.setColumnCount(4)
        self.solutionTable.setObjectName("solutionTable")
        self.solutionTable.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.solutionTable.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.solutionTable.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.solutionTable.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.solutionTable.setHorizontalHeaderItem(3, item)
        self.solutionTable.horizontalHeader().setVisible(True)
        self.solutionTable.horizontalHeader().setDefaultSectionSize(161)
        self.solutionTable.horizontalHeader().setMinimumSectionSize(49)
        self.solutionTable.horizontalHeader().setStretchLastSection(False)
        self.solutionTable.verticalHeader().setVisible(False)
        self.solutionTable.verticalHeader().setCascadingSectionResizes(False)
        self.solutionTable.verticalHeader().setDefaultSectionSize(145)
        self.solutionTable.verticalHeader().setHighlightSections(True)
        self.solutionTable.verticalHeader().setStretchLastSection(False)
        self.aboutLabel = QtWidgets.QLabel(self.centralwidget)
        self.aboutLabel.setGeometry(QtCore.QRect(10, 730, 651, 16))
        self.aboutLabel.setObjectName("aboutLabel")
        self.statusLabel = QtWidgets.QLabel(self.centralwidget)
        self.statusLabel.setGeometry(QtCore.QRect(10, 750, 651, 20))
...
"}")
        ...
        self.MplWidget.setGeometry(QtCore.QRect(50, 500, 571, 231))
        self.MplWidget.setStyleSheet("background-color:transparent;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Genetic Algorithm Python GUI Homework"))
        self.equationInputsLabel.setText(_translate("MainWindow", "Equation Inputs"))
        self.numberWeightsLabel.setText(_translate("MainWindow", "Number Weights"))
        self.solutionPopulationLabel.setText(_translate("MainWindow", "Solution Population"))
        self.lowLabel.setText(_translate("MainWindow", "Low"))
        self.generateButton.setText(_translate("MainWindow", "Generate"))
        self.equationInputsEdit.setText(_translate("MainWindow", "4,-2,3.5,5,-11,-4.7"))
        self.numberWeightsEdit.setText(_translate("MainWindow", "6"))
        self.solutionPopulationEdit.setText(_translate("MainWindow", "8"))
        self.lowEdit.setText(_translate("MainWindow", "-4.0"))
        self.highLabel.setText(_translate("MainWindow", "High"))
        self.numOfGenerationsLabel.setText(_translate("MainWindow", "Num of Generations"))
        self.numParentsMatingLabel.setText(_translate("MainWindow", "Num Parents Mating"))
        self.highEdit.setText(_translate("MainWindow", "4.0"))
        self.numOfGenerationsEdit.setText(_translate("MainWindow", "100"))
        self.numParentsMatingEdit.setText(_translate("MainWindow", "4"))
        self.resetAllDataButton.setText(_translate("MainWindow", "Reset All Data ( Including Results )"))
        self.clearInputsButton.setText(_translate("MainWindow", "Clear Inputs ( Including Default Values )"))
        self.exitButton.setText(_translate("MainWindow", "Exit"))
        item = self.solutionTable.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Generation"))
        item = self.solutionTable.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Best Result"))
        item = self.solutionTable.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Best Solution"))
        item = self.solutionTable.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "BS Fitness"))
        self.aboutLabel.setText(_translate("MainWindow", "Used PyGAD library(github.com/ahmedfgad/GeneticAlgorithmPython)                                                                          Erkan ÇEVİKGEDEY"))
        self.statusLabel.setText(_translate("MainWindow", "Status: Waiting For User Input"))
